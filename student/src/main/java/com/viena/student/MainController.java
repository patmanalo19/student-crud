...
@Controller
@RequestMapping(path="/ladao/student") // Updated URI
public class MainController {
    ...
    public ResponseEntity createStudent(@RequestBody Student student) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/ladao/student/" + savedStudent.getId())).body(savedStudent);
    }
